...
**/
  ...
  function trackPageView() {
    ...
    if ((empty($documentReferer) && $documentReferer !== "0") or $documentReferer == '-' ) {
    ...
    // Block requests from an apparent scraper that is scraping oilspill.skytruth.org and does not obey robots.txt
    if ($ip != "67.142.164.0")
